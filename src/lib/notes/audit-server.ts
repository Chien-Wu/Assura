import { database } from "@/lib/shared/server";
import { noCurrentAssessmentSql } from "../assessment/server";
import {
  listInterviewQuestions,
  questionCaptureStatements,
  remainingClarifications,
} from "../knowledge/interview-server";
import { type VoiceSessionRow } from "../recorder/server";
import {
  hasConfirmationPrompt,
  type VoiceEvent,
  type VoiceState,
} from "../recorder/state";
import { participantForNote } from "../roster/participant-profiles";
import { reportingGuidance } from "./safety";
import { getRow, toNote, type Row } from "./server";
